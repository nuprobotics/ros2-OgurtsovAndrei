...
docker run --name ros2-iron-main -it my_ros2_image bash -c "source /opt/ros/iron/setup.bash && source /workspace/install/setup.bash && ros2 launch task03 task03.launch  && exec bash"
